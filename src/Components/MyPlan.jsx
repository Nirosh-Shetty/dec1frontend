...
const MyPlan = () => {
  ...
  const fetchSavings = async () => {
    ...
    try {
      ...
      const res = await axios.get(
        `https://dd-backend-3nm0.onrender.com013/api/user/savings/lifetime-savings/${userId}`,
      );
      if (res.data.success) {
  ...
  const fetchPlans = async () => {
    ...
    try {
      ...
      const res = await axios.get(
        `https://dd-backend-3nm0.onrender.com013/api/user/plan/get-plan/${userId}`,
      );
      if (res.data.success) {
  ...
  const getDeliveryRates = async () => {
    try {
      const res = await axios.get(
        "https://dd-backend-3nm0.onrender.com013/api/deliveryrate/all",
      );
 ...
 const handleSkipOrCancel = async (planId, userId, planStatus) => {
      ...
      try {
        setLoading(true);
        await axios.post("https://dd-backend-3nm0.onrender.com013/api/user/plan/skip-cancel", {
          planId,
          userId,
        });
  ...
  //         "https://dd-backend-3nm0.onrender.com013/api/user/plan/update-product",
  //         {
  ...
  //         `https://dd-backend-3nm0.onrender.com013/api/User/customers/${userId}/addresses/${addressId}/primary`,
  //       );
  ...
  //         "https://dd-backend-3nm0.onrender.com013/api/user/plan/update-address",
  //         {
  //           planId: localPlan._id,
  //           userId,
  ...
  async function handlePayPlan(
    ...
    try {
      ...
      if (amount === 0) {
        ...
        const configObj = {
          method: "post",
          baseURL: "https://dd-backend-3nm0.onrender.com013/api/",
