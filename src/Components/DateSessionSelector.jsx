...
const sessionConfig = {
  ...
  Lunch: { icon: WiDaySunny, deliveryTime: "12-1 PM", displayName: "Lunch" },
  Dinner: {
    icon: IoMoonOutline,
    deliveryTime: "7-8 PM",
    displayName: "Dinner",
...
const DateSessionSelector = ({
  ...
  const getDeliveryTime = (session) =>
    sessionConfig[session]?.deliveryTime || "";
    ...
    <div className="date-session-wrapper">
      <div className="session-container">
        {sessionOrder.map((session) => {
          ...
          const deliveryTime = getDeliveryTime(session);
          ...
          return (
            ...
            >
              ...
              <div className="session-info">
                ...
                <div className="session-delivered-by">Delivered by</div>
                {isActive ? (
                  <div className="subtext2 active">{deliveryTime}</div>
                ) : (
                  <div className="session-delivery-time-plain">
                    {deliveryTime}
                  </div>
                )}
              </div>
