...
const UserBanner = () => {
  ...
  const handlePrev = () => {
    ...
    // If Bootstrap carousel is initialized, use it
  ...
  return (
    ...
    >
      ...
      >
            ...
            >
              <Link to="/refer">
                ...
                >
                  ...
                  >
                    {/* Uncomment if you want to show banner text */}
                    {/* {banner.BannerText && (
                      <h3
                        className="fw-bold mb-2"
                        style={{
        ...
        {banners.length > 1 && (
          <>
            {/* Left Arrow - Fixed with outline: none to prevent movement */}
            <button
              onClick={handlePrev}
              style={{
                position: "absolute",
              ...
              onMouseEnter={(e) => {
                e.target.style.backgroundColor = "rgba(107, 142, 35, 0.8)";
              }}
              onMouseLeave={(e) => {
                e.target.style.backgroundColor = "rgba(0, 0, 0, 0.5)";
              }}
              onMouseDown={(e) => {
                e.preventDefault(); // Prevent button from moving on click
              }}
            >
              {/* SVG Left Arrow */}
              <svg
            ...
            {/* Right Arrow - Fixed with outline: none to prevent movement */}
            <button
              onClick={handleNext}
              style={{
                position: "absolute",
