...
const TagsManager = () => {
    ...
    const createTag = async () => {
        try {
            ...
            await axios.post('https://dailydish-backend.onrender.com/api/admin/food-tags', { tagName: name, description: desc, tagColor: color });
    ...
    const saveEdit = async () => {
        try {
            await axios.put(`https://dailydish-backend.onrender.com/api/admin/food-tags/${editing._id}`, { tagName: name, description: desc, tagColor: color });
    ...
    const deleteTag = async (id) => {
        ...
        try { await axios.delete(`https://dailydish-backend.onrender.com/api/admin/food-tags/${id}`); load(); } catch (e) { alert('Error deleting'); }
    };
