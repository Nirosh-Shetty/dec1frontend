...
//   // Rider status options - Updated to match backend rider status values
...
//       link.setAttribute(
//         "download",
//         `Order_Tracking_Export_${dateStr}_${timeStr}.xlsx`,
//       );
...
//   // Get rider status display - Updated to show delivery status and attempt reason
//   const getRiderStatusDisplay = (order) => {
//     // Use riderStatus for delivery status, not rider.status
//     const deliveryStatus = order.riderStatus || "assigned";
//     const riderStatus =
//       riderStatusOptions.find((option) => option.value === deliveryStatus) ||
//       riderStatusOptions[0];

//     return (
//       <div className="rider-delivery-status">
//         <div
//           className="rider-status-badge"
//           style={{ backgroundColor: riderStatus.color }}
//         >
//           {riderStatus.icon}
//           <span>{riderStatus.label}</span>
//         </div>
//         {deliveryStatus === "Attempted Delivery" &&
//           order.riderAttemptReason && (
//             <div
...
//               }}
//             >
//               Reason: {order.riderAttemptReason}
//             </div>
//           )}
//       </div>
//     );
...
//           <h2>
//             <MdDashboard /> Order Tracking Dashboard
//           </h2>
//           <p>
//             Monitor all orders with real-time status updates and rider
//             information
//           </p>
//         </div>
...
//             {autoRefresh ? (
//               <>
//                 <FaPause /> Auto-Refresh ON
//               </>
//             ) : (
//               <>
//                 <FaPlay /> Auto-Refresh OFF
//               </>
//             )}
//           </button>
...
//             {exporting ? (
//               <>
//                 <FaSpinner className="spinning" /> Exporting...
//               </>
//             ) : (
//               <>
...
//               <FaShoppingBag /> <strong>{filteredOrders.length}</strong> Total
//               Orders
//             </span>
...
//                               order._id?.slice(-8)}
//                           </strong>
//                           <div className="order-type">{order.addressType}</div>
//                         </div>
//                       </div>
...
//                               <strong>
//                                 <FaMotorcycle /> {order.riderId.name}
//                               </strong>
//                               <div className="rider-phone">
//                                 <FaPhone /> {order.riderId.phone}
//                               </div>
//                             </div>
//                             <div className="rider-status">
//                               {getRiderStatusDisplay(order)}
//                             </div>
//                           </div>
//                         ) : (
...
//                             </span>
//                             <div className="assign-rider-hint">
...
//                             <FaShoppingBag /> {order.allProduct?.length || 0}{" "}
//                             items
//                           </div>
//                         </div>
//                       </div>
...
//                           <div className="date">
//                             <FaTruck /> {deliveryDateTime.date || "Today"}
//                           </div>
...
//                         <div className="date-time">
//                           <div className="date">
//                             <FaCalendarAlt /> {orderDateTime.date}
//                           </div>
//                           <div className="time">
//                             <FaClock /> {orderDateTime.time}
//                           </div>
//                         </div>
//                       </div>
...
//                             onClick={() =>
//                               showInfo(
//                                 `Order Details: ${order.delivarylocation}`,
//                                 5000,
//                               )
//                             }
//                             title="View Details"
...
//                             onClick={() =>
//                               showInfo(
//                                 `Location: ${order.delivarylocation}`,
//                                 5000,
//                               )
//                             }
//                             title="View Location"
...
//                 <FaShoppingBag /> Showing {indexOfFirstOrder + 1} to{" "}
...
const OrderTracking = () => {
  ...
  const assignRider = async () => {
    if (!selectedRider) {
      showError("Please select a rider", 3000);
      return;
    }
    ...
    try {
      ...
      if (response.data.success) {
        showSuccess(
          `Rider assigned successfully to order ${selectedOrder.orderid || selectedOrder._id?.slice(-8)}`,
          3000,
        );
      ...
      showError("Failed to assign rider. Please try again.", 4000);
    } finally {
    ...
    <div className="order-tracking-container">
      ...
      <div className="filters-section">
        ...
        <div className="stats-row">
          <div className="stats-line">
            <span className="stat-item">
              <FaShoppingBag /> <strong>{totalOrders}</strong> Total Orders
            </span>
            {statusOptions.slice(1).map((status) => {
              const count = filteredOrders.filter(
                (order) => order.status === status.value,
        ...
        <div className="modal-overlay" onClick={closeAssignModal}>
          <div className="modal-content" onClick={(e) => e.stopPropagation()}>
            <div className="modal-header">
              <h3>
                <FaMotorcycle /> Assign Rider to Order
              </h3>
            ...
            <div className="modal-body">
              ...
              {riders.length === 0 && (
                <div className="no-riders-warning">
                  <FaExclamationCircle /> No riders available. Please add riders
                  first.
                </div>
              )}
            </div>
            ...
            <div className="modal-footer">
              ...
              <button
                ...
                onClick={assignRider}
                disabled={
                  assigningRider || !selectedRider || riders.length === 0
                }
              >
                {assigningRider ? (
                  <>
                    <FaSpinner className="spinning" /> Assigning...
                  </>
                ) : (
                  <>
                    <FaCheck /> Assign Rider
                  </>
                )}
              </button>
            </div>
