  ...
  const fetchClosureDetails = async () => {
    try {
      const response = await axios.get(
        "https://dd-backend-3nm0.onrender.com/api/admin/getClosureDetails",
      );
  ...
  const handleSubmit = async () => {
    try {
      ...
      const response = await axios.post(
        "https://dd-backend-3nm0.onrender.com/api/admin/setClosure",
        formData,
        {
  ...
  const clearClosure = async () => {
    try {
      ...
      const response = await axios.delete(
        "https://dd-backend-3nm0.onrender.com/api/admin/clearClosure",
      );
      if (response.status === 200) {
