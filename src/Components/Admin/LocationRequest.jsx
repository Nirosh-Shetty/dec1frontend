...
//       const response = await axios.get(`https://dd-backend-3nm0.onrender.com/api/service-requests?${params}`);
...
//       const response = await axios.get('https://dd-backend-3nm0.onrender.com/api/service-requests/stats', {
//         headers: {
...
//         `https://dd-backend-3nm0.onrender.com/api/service-requests/${requestId}`,
//         {
//           status: updateStatus,
//           notes: updateNotes
//         },
...
//         `https://dd-backend-3nm0.onrender.com/api/service-requests?${params}`,
//         {
//           headers: {
//             Authorization: `Bearer ${token}`,
//           },
...
//       const token = localStorage.getItem("token");
//       const response = await axios.get(
//         "https://dd-backend-3nm0.onrender.com/api/service-requests/stats",
//         {
//           headers: {
//             Authorization: `Bearer ${token}`,
//           },
...
const LocationRequest = () => {
  ...
  const fetchAllLocations = async () => {
    try {
      ...
      const response = await axios.get(
        `https://dd-backend-3nm0.onrender.com/api/service-requests/map-locations?${params}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
