...
//       const response = await axios.get(`https://dailydish-backend.onrender.com/api/service-requests?${params}`);
...
//       const response = await axios.get('https://dailydish-backend.onrender.com/api/service-requests/stats', {
//         headers: {
...
//         `https://dailydish-backend.onrender.com/api/service-requests/${requestId}`,
//         {
//           status: updateStatus,
//           notes: updateNotes
//         },
...
//         `https://dailydish-backend.onrender.com/api/service-requests?${params}`,
//         {
//           headers: {
//             Authorization: `Bearer ${token}`,
//           },
...
//       const token = localStorage.getItem("token");
//       const response = await axios.get(
//         "https://dailydish-backend.onrender.com/api/service-requests/stats",
//         {
//           headers: {
//             Authorization: `Bearer ${token}`,
//           },
...
const LocationRequest = () => {
  ...
  const fetchAllLocations = async () => {
    try {
      ...
      const response = await axios.get(
        `https://dailydish-backend.onrender.com/api/service-requests/map-locations?${params}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
