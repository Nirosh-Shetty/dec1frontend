...
//         "https://dd-backend-3nm0.onrender.com/api/admin/admin/product"
//       );
//       if (res.status === 200) {
...
//         `https://dd-backend-3nm0.onrender.com/api/admin/admin/deleteproduct/${delData._id}`
//       );
//       if (res) {
...
//     try {
//       let res = await axios.get("https://dd-backend-3nm0.onrender.com/api/admin/getcategory");
//       if (res.status === 200) {
...
//         "https://dd-backend-3nm0.onrender.com/api/admin/admin/updateGalleryImages",
//         formData,
//         {
//           headers: { "Content-Type": "multipart/form-data" },
//         }
...
//     try {
//       const config = {
//         url: `https://dd-backend-3nm0.onrender.com/api/admin/admin/DeleteGalleryimage/${Data?._id}`,
//         method: "delete",
//         baseURL: "https://dd-backend-3nm0.onrender.com/api/",
