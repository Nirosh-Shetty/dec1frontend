...
//         `https://api.dailydish.in/api/admin/admin/deleteproduct/${delData._id}`
//       );
//       if (res) {
...
//     try {
//       let res = await axios.get("https://api.dailydish.in/api/admin/getcategory");
//       if (res.status === 200) {
...
//         "https://api.dailydish.in/api/admin/admin/updateGalleryImages",
//         formData,
//         {
//           headers: { "Content-Type": "multipart/form-data" },
//         }
...
//     try {
//       const config = {
//         url: `https://api.dailydish.in/api/admin/admin/DeleteGalleryimage/${Data?._id}`,
//         method: "delete",
//         baseURL: "https://api.dailydish.in/api/",
