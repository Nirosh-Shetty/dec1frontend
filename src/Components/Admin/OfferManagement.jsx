...
//     try {
//       const res = await axios.get('https://dailydish-backend.onrender.com/api/admin/offers');
//       if (res.status === 200) {
...
//       setLoader(true);
//       try {
//         const res = await axios.get('https://dailydish-backend.onrender.com/api/admin/getFoodItemsUnBlocks');
//         if (res.status === 200) {
...
//       let response;
//       if (editingOffer) {
//         response = await axios.put(`https://dailydish-backend.onrender.com/api/admin/offers/${editingOffer._id}`, {
...
//       } else {
//         response = await axios.post('https://dailydish-backend.onrender.com/api/admin/offers', {
//           products: formattedProducts,
//           startDate,
//           endDate,
//         });
...
//       try {
//         await axios.delete(`https://dailydish-backend.onrender.com/api/admin/offers/${offerId}`);
//         getOffers();
//         Swal.fire({
//           title: 'Deleted!',
    ...
    try {
      ...
      if (editingOffer) {
        response = await axios.put(
          `https://dailydish-backend.onrender.com/api/admin/offers/${editingOffer._id}`,
          {
            products: formattedProducts,
            startDate,
            endDate,
...
const BannerForm = () => {
  ...
  useEffect(() => {
    const getBannerImages = async () => {
      try {
        const res = await axios.get(
          "https://dailydish-backend.onrender.com/api/admin/banners/images"
        );
        if (res.status === 200) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (editingBanner) {
        ...
        responses = [
          await axios.put(
            `https://dailydish-backend.onrender.com/api/admin/editbanner/${editingBanner._id}`,
            formData,
            {
        ...
        responses = await Promise.all(
          formDataArray.map((formData) =>
            axios.post("https://dailydish-backend.onrender.com/api/admin/banners", formData, {
              headers: { "Content-Type": "multipart/form-data" },
            })
          )
        );
  ...
  const handleDelete = async (bannerId) => {
    ...
    if (result.isConfirmed) {
      try {
        await axios.delete(
          `https://dailydish-backend.onrender.com/api/admin/Deletebanner/${bannerId}`
        );
...
const Reports = () => {
    ...
    const fetchReports = async () => {
      try {
        const response = await axios.get(
          "https://dailydish-backend.onrender.com/api/admin/reports"
        );
  ...
  const handleExport = async () => {
    try {
      window.location.href = "https://dailydish-backend.onrender.com/api/admin/reports/export";
      Swal.fire({
        title: "Success",
