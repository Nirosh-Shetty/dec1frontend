...
const API_URL = "https://dd-merge-backend-2.onrender.com/api/admin/hub-menu";
// API URL for Admin actions (Products, Hubs)
const ADMIN_API_URL = "https://dd-merge-backend-2.onrender.com/api/admin";
const HUB_API_URL = "https://dd-merge-backend-2.onrender.com/api/Hub";
